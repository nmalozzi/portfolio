  ...
  return (
    <nav className={style.nav}>
      ...
      <div className={style.socialLinks}>
        ...
        <a
            href="https://github.com/nmalozzi"
            target="_blank"
            rel="noreferrer"
            aria-label="Nick Malozzi's Github"
        >
        ...
        <a
            href="https://codepen.io/nmalozzi"
            target="_blank"
            rel="noreferrer"
            aria-label="Nick Malozzi's Codepen"
        >
          <svg
            className={style.socialIcon}
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
            href="mailto:nick@malozzi.codes"
            target="_blank"
            rel="noreferrer"
            aria-label="Nick Malozzi's Email"
        >
          <svg
            className={style.socialIcon}
            xmlns="http://www.w3.org/2000/svg"
